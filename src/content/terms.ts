...
export const TERMS: Record<string, TermDef> = {
  ...
  'hosting':         { id: 'hosting', label: 'Hosting', short: 'Throw an evening in your own room — you pick the guest circle. Priced in coin, and the guest list is on the record.', entry: null },
  'recruit':         { id: 'recruit', label: 'Recruit', short: 'Turn a townsperson into an asset through one of the four MICE handles — each buys loyalty, each fails its own way.', entry: null },
  ...
  'courier':         { id: 'courier', label: 'Courier', short: 'An asset who carries your story to a target on their own schedule — store-and-forward, no meeting with you needed.', entry: null },
