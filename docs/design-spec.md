...
- **Self-rumor reactions (Ellie's amendment #3, 2026-07-04) — design resolved:** a rumor about you is bait — it pulls actions (investigate / counter-spin / amplify, by valence + stance), not retellings; full system ships with the enemy AI. Interim kernel behavior recorded in the execution ledger.
